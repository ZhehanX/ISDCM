# Informe Técnico — LAB 1: Aplicación Web de Gestión de Vídeos
...
El presente informe describe el diseño, la implementación y las decisiones técnicas adoptadas en el desarrollo del **LAB 1**, cuyo objetivo es construir una aplicación web de gestión de vídeos. La aplicación permite a los usuarios registrarse, autenticarse y, una vez autenticados, registrar vídeos y consultar el listado completo de vídeos almacenados en la base de datos.
...
| Empaquetado | WAR (`LAB1-1.0-SNAPSHOT.war`) |
...
El LAB 1 implementa una aplicación web funcional de gestión de vídeos que cumple con los requisitos fundamentales del proyecto:
